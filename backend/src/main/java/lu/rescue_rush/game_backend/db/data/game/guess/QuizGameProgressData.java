...
@GeneratedKey("id")
public class QuizGameProgressData implements SafeSQLEntry {
	...
	public QuizGameProgressData() {
	}

	public QuizGameProgressData(int id, int userId, Date date, int totalPoints, int correctQuestionCount, int totalQuestionCount, int highestStreak, int maxMultiplier, int startedGameCount,
	...
	public QuizGameProgressData(UserData ud) {
		this(ud.getId());
	}

	public QuizGameProgressData(int userId) {
		this.userId = userId;
	}

	public QuizGameProgressData startGame(QuizGameData game) {
		this.startedGameCount++;

		return this;
	}

	public QuizGameProgressData updateQuestion(QuizGameData game, int pointsAdd, boolean success) {
	...
	@Override
	public QuizGameProgressData clone() {
		return new QuizGameProgressData();
	}
	...
	public String toString() {
		return "GuessGameProgressData [id=" + id + ", userId=" + userId + ", date=" + date + ", totalPoints=" + totalPoints + ", correctQuestionCount=" + correctQuestionCount + ", totalQuestionCount="
	...
	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserId(UserData ud) {
		return byUserId(ud.getId());
	}

	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserId(int userId) {
		return new SQLQuery.SafeSQLQuery<QuizGameProgressData>() {
			@Override
			...
			@Override
			public String getPreparedQuerySQL(SQLQueryable<QuizGameProgressData> table) {
	...
	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byDate(Date date) {
		return new SQLQuery.SafeSQLQuery<QuizGameProgressData>() {
			@Override
			public void updateQuerySQL(PreparedStatement stmt) throws SQLException {
				stmt.setDate(1, date);
	...
	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserIdAndDate(UserData ud, Date date) {
		return byUserIdAndDate(ud.getId(), date);
	}

	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserIdAndDate(int userId, Date date) {
		return new SQLQuery.SafeSQLQuery<QuizGameProgressData>() {
			@Override
			public void updateQuerySQL(PreparedStatement stmt) throws SQLException {
				stmt.setInt(1, userId);
	...
	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserIdAndToday(UserData ud) {
		return byUserIdAndToday(ud.getId());
	}

	public static SQLQuery.SafeSQLQuery<QuizGameProgressData> byUserIdAndToday(int userId) {
		return new SQLQuery.SafeSQLQuery<QuizGameProgressData>() {
			@Override
			public void updateQuerySQL(PreparedStatement stmt) throws SQLException {
				stmt.setInt(1, userId);
