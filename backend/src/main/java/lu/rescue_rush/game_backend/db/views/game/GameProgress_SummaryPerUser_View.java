...
//@formatter:off
@DB_View(name = "game_progress_summary_per_user", tables = {
...
orderBy = { @OrderBy(column = "user_id") })
//@formatter:on
@Service
public class GameProgress_SummaryPerUser_View extends R2DBView<ScenarioGameProgressData> {

	@Autowired
	private GameProgress_View gameProgress;

	public GameProgress_SummaryPerUser_View(DataBase dbTest) {
		super(dbTest);
	}
