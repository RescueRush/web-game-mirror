...
//@formatter:off
@DB_View(name = "quiz_game_stats_filtered_leaderboard", tables = {
...
//@formatter:on
@Service
public class QuizGameStats_FilteredLeaderboard_View extends R2DBView<LeaderboardData> implements LeaderboardView {
	...
	public QuizGameStats_FilteredLeaderboard_View(DataBase dbTest) {
		super(dbTest);
	}
