package lu.rescue_rush.game_backend.db.tables;
...
public class R2DBTable<T extends SQLEntry> extends DataBaseTable<T> {

	protected Logger LOGGER;

	public R2DBTable(DataBase dbTest) {
		super(dbTest);

		LOGGER = Logger.getLogger("TABLE # " + super.getName());
	}
