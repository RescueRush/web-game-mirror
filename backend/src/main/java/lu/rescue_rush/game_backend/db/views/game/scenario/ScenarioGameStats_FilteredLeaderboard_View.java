...
//@formatter:off
@DB_View(name = "scenario_game_stats_filtered_leaderboard", tables = {
...
//@formatter:on
@Service
public class ScenarioGameStats_FilteredLeaderboard_View extends R2DBView<LeaderboardData> implements LeaderboardView {
	...
	public ScenarioGameStats_FilteredLeaderboard_View(DataBase dbTest) {
		super(dbTest);
	}
