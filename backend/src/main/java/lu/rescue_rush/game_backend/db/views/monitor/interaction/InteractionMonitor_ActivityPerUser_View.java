...
//@formatter:off
@DB_View(name = "interaction_monitor_activity_per_user", tables = {
...
//@formatter:on
@Service
public class InteractionMonitor_ActivityPerUser_View extends R2DBView<InteractionMonitoringEntryData> {

	@Autowired
	private InteractionMonitorTable userTracking;

	public InteractionMonitor_ActivityPerUser_View(DataBase dbTest) {
		super(dbTest);
	}
