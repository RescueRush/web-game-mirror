...
//@formatter:off
@DB_View(name = "interaction_monitor_count_per_type", tables = {
...
//@formatter:on
@Service
public class InteractionMonitor_CountPerType_View extends R2DBView<InteractionMonitoringEntryData> {

	@Autowired
	private InteractionMonitorTable userTracking;

	public InteractionMonitor_CountPerType_View(DataBase dbTest) {
		super(dbTest);
	}
