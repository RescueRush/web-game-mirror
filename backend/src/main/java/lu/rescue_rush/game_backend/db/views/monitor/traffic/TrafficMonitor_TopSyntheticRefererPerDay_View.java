...
//@formatter:off
@DB_View(name = "traffic_monitor_top_synthetic_referer_per_day", tables = {
...
//@formatter:on
@Service
public class TrafficMonitor_TopSyntheticRefererPerDay_View extends R2DBView<AggregateTrafficData> {

	@Autowired
	private TrafficMonitorTable trafficMonitoring;

	public TrafficMonitor_TopSyntheticRefererPerDay_View(DataBase dbTest) {
		super(dbTest);
	}
