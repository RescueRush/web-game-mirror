...
//@formatter:off
@DB_View(name = "traffic_monitor_summary_per_minute", tables = {
		@ViewTable(typeName = TrafficMonitorTable.class, columns = {
				@ViewColumn(func = "DATE_FORMAT(`datetime`, '%Y-%m-%d %H:%i:00')", asName = "time"),
...
//@formatter:on
@Service
public class TrafficMonitor_SummaryPerMinute_View extends R2DBView<AggregateTrafficData> {

	@Autowired
	private TrafficMonitorTable trafficMonitoring;

	public TrafficMonitor_SummaryPerMinute_View(DataBase dbTest) {
		super(dbTest);
	}
