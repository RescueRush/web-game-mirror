...
//@formatter:off
@DB_View(name = "traffic_monitor_summary_per_day", tables = {
...
//@formatter:on
@Service
public class TrafficMonitor_SummaryPerDay_View extends R2DBView<AggregateTrafficData> {

	@Autowired
	private TrafficMonitorTable trafficMonitoring;

	public TrafficMonitor_SummaryPerDay_View(DataBase dbTest) {
		super(dbTest);
	}
