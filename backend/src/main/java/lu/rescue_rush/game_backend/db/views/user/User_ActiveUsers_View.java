...
//@formatter:off
@DB_View(name = "user_active_users", tables = {
...
}, condition = "last_login > NOW() - INTERVAL 30 DAY",
orderBy = { @OrderBy(column = "last_login", type = OrderBy.Type.DESC) })
//@formatter:on
@Service
public class User_ActiveUsers_View extends R2DBView<UserData> {

	@Autowired
	private UserTable users;

	public User_ActiveUsers_View(DataBase dbTest) {
		super(dbTest);
	}
