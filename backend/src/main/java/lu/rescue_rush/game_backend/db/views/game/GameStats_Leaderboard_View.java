...
//@formatter:off
@DB_View(name = "game_stats_leaderboard", tables = {
...
//@formatter:on
@Service
public class GameStats_Leaderboard_View extends R2DBView<LeaderboardData> implements LeaderboardView {
	...
	public GameStats_Leaderboard_View(DataBase dbTest) {
		super(dbTest);
	}
