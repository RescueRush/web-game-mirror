...
//@formatter:off
@DB_View(name = "traffic_monitor_top_referer_per_hour", tables = {
...
//@formatter:on
@Service
public class TrafficMonitor_TopRefererPerHour_View extends R2DBView<AggregateTrafficData> {

	@Autowired
	private TrafficMonitorTable trafficMonitoring;

	public TrafficMonitor_TopRefererPerHour_View(DataBase dbTest) {
		super(dbTest);
	}
