...
//@formatter:off
@DB_View(name = "newsletter_subscription_action", tables = {
...
//@formatter:on
@Service
public class NewsletterSubscription_SourceAction_View extends R2DBView<NewsletterSubscriptionData> {

	@Autowired
	private NewsletterSubscriptionTable newsletterEmailTable;

	public NewsletterSubscription_SourceAction_View(DataBase dbTest) {
		super(dbTest);
	}
