...
import lu.rescue_rush.game_backend.integrations.discord.modals.ModalUserHideConfirm;
...
@Component
public class CmdUserHide implements SlashCommandExecutor, SlashCommandAutocomplete {

	private static final Logger LOGGER = Logger.getLogger(CmdUserHide.class.getName());

	@Autowired
	private ModalUserHideConfirm modalUserHide;
	...
	public void execute(SlashCommandInteractionEvent event) {
		...
		event.replyModal(modalUserHide.build(ud.getId())).complete();
	}
	...
	public String description() {
		return "Hides the specified user.";
	}
